...
class Day198 extends StatelessWidget {
  const Day198({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: <Widget>[
          ...
          _buildRecentWikiRow(
              "images/assets199/Avatar 3.jpg", "Brand Guideline"),
          const SizedBox(height: 5.0),
          _buildRecentWikiRow(
              "images/assets199/Avatar 4.jpg", "Project Grail Sprint plan"),
          const SizedBox(height: 5.0),
          _buildRecentWikiRow("images/assets199/Avatar 5.jpg", "Personal Wiki"),
