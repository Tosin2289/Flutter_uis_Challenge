...
class Day194 extends StatelessWidget {
  const Day194({Key? key}) : super(key: key);
          ...
          Material(
            ...
            child: Container(
              ...
              child: ListView(
                ...
                children: <Widget>[
                  _buildBottomImage("images/assets194/img1.jpg"),
                  const SizedBox(
                    width: 10.0,
                  ),
                  _buildBottomImage("images/assets194/img2.jpg"),
                  const SizedBox(
                    width: 10.0,
                  ),
                  _buildBottomImage("images/assets194/img3.jpg"),
                  const SizedBox(
                    width: 10.0,
                  ),
                  _buildBottomImage("images/assets194/img4.jpg"),
                  const SizedBox(
                    width: 10.0,
                  ),
                  _buildBottomImage("images/assets194/img5.jpg"),
                ],
              ),
            ),
          )
