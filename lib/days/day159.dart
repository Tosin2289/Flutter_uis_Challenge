...
const Color primaryColor = Color(0xffFD6592);
const Color bgColor = Color(0xffF9E0E3);
const Color secondaryColor = Color(0xff324558);

class Day159 extends StatelessWidget {
  ...
  const Day159({Key? key}) : super(key: key);
  @override
...
Widget _buildArticleItem(int index) {
  ...
  const String sample = "images/assets159/img1.jpeg";
  return Container(
    color: Colors.white,
    child: Stack(
      children: <Widget>[
